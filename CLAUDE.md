...
**Wicflow Meet** is a privacy-first AI meeting assistant that captures, transcribes, and summarizes meetings entirely on local infrastructure. Forked from [Meetily](https://github.com/Zackriya-Solutions/meeting-minutes). The project consists of two main components:
...
- **Production (macOS)**: `~/Library/Application Support/wicflow-meet/models/`
- **Production (Windows)**: `%APPDATA%\wicflow-meet\models\`
