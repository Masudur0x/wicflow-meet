        ...
        match Command::new("osascript")
            ...
            .arg(r#"
                tell application "Terminal"
                    activate
                    do script "log stream --process wicflow-meet --level info --style compact"
                end tell
            "#)
            .spawn()
        {
            ...
            .arg(r#"
                tell application "Terminal"
                    ...
                    repeat with aWindow in windowList
                        if contents of selected tab of aWindow contains "log stream --process wicflow-meet" then
                            close aWindow
                        end if
                    end repeat
                end tell
